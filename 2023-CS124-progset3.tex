...
\fbox{\parbox{0.9\linewidth}{
    ...
    This would not affect the repeated random algorithm, since it generates a 
    random solution each time. However, it would affect the hill climbing and
    simulated annealing algorithms. They would both start at a state closer to the
    solution state. 
